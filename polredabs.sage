...
def eisenstein_form(L, K): # Hold off for now
    """
    ...
    EXAMPLES:
        ...
        sage: phi, nu, gamma = eisenstein_form(L,K)
        sage: phi, nu, gamma, phi(gamma)
        MAGMA: x^2 - 3 + O(3^20), x, a + O(a^40), O(a^40)
        what sage is currently giving: 
        ((1 + O(3^20))*x^2 + O(3^21)*x + 2*3 + 2*3^2 + 2*3^3 + 2*3^4 + 2*3^5 + 2*3^6 + 2*3^7 
        + 2*3^8 + 2*3^9 + 2*3^10 + 2*3^11 + 2*3^12 + 2*3^13 + 2*3^14 + 2*3^15 + 2*3^16 
        + 2*3^17 + 2*3^18 + 2*3^19 + 2*3^20 + O(3^21),
        (1 + O(3^20))*x, a + O(a^41), O(a^42))
    """
