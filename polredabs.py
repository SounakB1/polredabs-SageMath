...
phi = x^2 - 3 # irreducible and eisenstein
alpha_field = K.extension(phi, names='x')
alpha = alpha_field.gen()

nu = x
m = 1

Sm, cont = residual_polynomial_of_component_abs(phi, nu, alpha, m)
print(Sm, ",", cont)
